...
export const cohortsData: Cohort[] = [
  ...
  },
  {
    ...
    tag: "Industry",
    title: "Multi-Agent Pipeline for Healthcare Claims",
  ...
  },
  {
    ...
    deliverables:[
                    "Data dictionary, project plan.",
                    "Clean dataset, augmentation scripts.",
                    "EDA report, cluster plots.",
                    "First accuracy benchmarks.",
                    "Fine-tuned models, results.",
                    "Experiments with EfficientNet/UNet.",
                    "Heatmap visualizations.",
                    "Report on what works/doesn’t.",
                    "Working demo UI.",
                    "Compare with research papers, write review.",
                    "Cross-team feedback, refine pipeline.",
                    "Presentation, report, blogs."
                ],
    documents_list: " ",
